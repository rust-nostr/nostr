...
* pool: join futures instead of spawning threads for `RelayPool::connect` ([Yuki Kishimoto])
* pool: join futures instead of spawning threads in `RelayPool::sync_targeted` ([Yuki Kishimoto])
