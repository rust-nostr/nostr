...
impl MatchEventOptions {
    ...
    /// Compare the event author with the filter.
    #[inline]
    pub fn match_author(mut self) -> Self {
        self.author = true;
        self
    }
    ...
    /// Compare the event kind with the filter.
    #[inline]
    pub fn match_kind(mut self) -> Self {
        self.kind = true;
        self
    }
    ...
    /// Compare the event tags with the filter.
    #[inline]
    pub fn match_tags(mut self) -> Self {
        self.tags = true;
        self
    }
    ...
    /// Check if event timestamp is after filter's `since`.
    #[inline]
    pub fn match_since(mut self) -> Self {
        self.since = true;
        self
    }
    ...
    /// Check if event timestamp is before filter's `until`.
    #[inline]
    pub fn match_until(mut self) -> Self {
        self.until = true;
        self
    }
    ...
    /// (basic NIP-50 implementation without extensions).
    #[inline]
    pub fn match_nip50(mut self) -> Self {
        self.nip50 = true;
        self
    }

    /// Disable matching the event id with the filter.
    #[inline]
    pub fn unmatch_id(mut self) -> Self {
        self.id = false;
        self
    }

    /// Disable matching the event author with the filter.
    #[inline]
    pub fn unmatch_author(mut self) -> Self {
        self.author = false;
        self
    }

    /// Disable matching the event kind with the filter.
    #[inline]
    pub fn unmatch_kind(mut self) -> Self {
        self.kind = false;
        self
    }

    /// Disable matching the event tags with the filter.
    #[inline]
    pub fn unmatch_tags(mut self) -> Self {
        self.tags = false;
        self
    }

    /// Disable checking if event timestamp is after filter's `since`.
    #[inline]
    pub fn unmatch_since(mut self) -> Self {
        self.since = false;
        self
    }

    /// Disable checking if event timestamp is before filter's `until`.
    #[inline]
    pub fn unmatch_until(mut self) -> Self {
        self.until = false;
        self
    }

    /// Disable checking if event content contains filter's search terms
    /// (basic NIP-50 implementation without extensions).
    #[inline]
    pub fn unmatch_nip50(mut self) -> Self {
        self.nip50 = false;
        self
    }
}
