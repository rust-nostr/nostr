...
impl EventBuilder {
    ...
    pub fn build_with_supplier<T>(self, supplier: &T, pubkey: PublicKey) -> UnsignedEvent
    where
        T: TimeSupplier,
    {
    ...
    pub fn to_unsigned_event(self, pubkey: PublicKey) -> UnsignedEvent {
        self.build_with_supplier(&Instant::now(), pubkey)
    }
        ...
        T: TimeSupplier,
    {
        ...
        Ok(self
            .build_with_supplier(supplier, pubkey)
        ...
        T: NostrSigner,
    {
        Ok(Self::new(
            Kind::NostrConnect,
            signer
                .nip04_encrypt(&receiver_pubkey, &msg.as_json())
                .await?,
