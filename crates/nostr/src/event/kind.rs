...
kind_variants! {
    ...
    DoubleRatchetMessage => 1060, "Double Ratchet message", "TDB",
    ...
    PrivateDirectMessage => 14, "Private Direct message", "<https://github.com/nostr-protocol/nips/blob/master/17.md> and TBD",
