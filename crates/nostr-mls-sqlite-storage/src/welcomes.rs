...
impl WelcomeStorage for NostrMlsSqliteStorage {
    fn save_welcome(&self, welcome: Welcome) -> Result<Welcome, WelcomeError> {
        ...
        let state_str: String = welcome.state.clone().into();
            ...
            .execute(
             ...
             VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
                params![
                    ...
                    &group_relays_json,
                    &welcome.welcomer.to_string(),
                    &(welcome.member_count as i64),
                    &state_str,
                    &welcome.wrapper_event_id.to_string()
                ],
            )
    ...
    fn find_welcome_by_event_id(&self, event_id: EventId) -> Result<Welcome, WelcomeError> {
        ...
        let welcome = stmt
            .query_row(params![event_id.to_string()], db::row_to_welcome)
            .map_err(|e| match e {
                rusqlite::Error::QueryReturnedNoRows => WelcomeError::NotFound,
                _ => WelcomeError::DatabaseError(e.to_string()),
            })?;
    ...
    fn save_processed_welcome(
        ...
        // Convert state to string
        let state_str: String = processed_welcome.state.clone().into();
        ...
        conn_guard
            .execute(
             ...
             VALUES (?, ?, ?, ?, ?)",
                params![
                    &processed_welcome.wrapper_event_id.to_string(),
                    &welcome_event_id,
    ...
    fn find_processed_welcome_by_event_id(
        ...
        let processed_welcome = stmt
            .query_row(params![event_id.to_string()], db::row_to_processed_welcome)
            .map_err(|e| match e {
                rusqlite::Error::QueryReturnedNoRows => WelcomeError::NotFound,
                _ => WelcomeError::DatabaseError(e.to_string()),
            })?;
