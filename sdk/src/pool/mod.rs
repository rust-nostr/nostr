...
use crate::relay::{
    AtomicRelayCapabilities, Reconciliation, Relay, RelayCapabilities, RelayOptions, ReqExitPolicy,
    SubscribeOptions, SyncOptions,
};
...
impl RelayPool {
    ...
    pub(crate) async fn add_relay(
        ...
        // Compose new relay
        let mut relay: Relay =
            Relay::new_shared(url.clone(), self.inner.state.clone(), capabilities, opts);
