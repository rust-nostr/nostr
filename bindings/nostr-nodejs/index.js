...
const { EventBuilder, EventId, Event, PublicKey, SecretKey, Keys, SubscriptionId, Filter, encrypt, decrypt, verifyNip05, RelayInformationDocument, signDelegation, verifyDelegationSignature, ChannelId, Contact, Metadata } = nativeBinding
