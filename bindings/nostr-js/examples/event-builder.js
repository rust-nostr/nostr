...
function main() {
    ...
    let event = new EventBuilder(BigInt(1), "Testing nostr JS bindings", [Tag.parse(["p", "d0a59cd44b6051708e9d437aa01f86451378a130ea7ba38ad43eae0bd0e0c4ce"])]).toEvent(keys);
